  ...
  Future<void> _fetchMyProducts() async {
    ...
    try {
      final Uri url = Uri.parse(
        '$baseUrl/api/products/my-products',
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _errorMessage =
              responseData['message'] ?? 'Failed to fetch your products.';
        });
      }
    } catch (e) {
      setState(() {
    ...
    return Scaffold(
      ...
      floatingActionButton:
          _myProducts.isNotEmpty ||
              _isLoading // Show FAB even if loading or empty to allow adding first product
