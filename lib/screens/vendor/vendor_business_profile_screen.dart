  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      setState(() {
        ...
        _deliveryRadiusController.text = (body['deliveryRadiusKm'] ?? 15)
            .toString();
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'operatingHours': _operatingHours.map((hour) => hour.toJson()).toList(),
      };
