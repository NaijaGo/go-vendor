...
class _VendorScreenState extends State<VendorScreen>
  ...
  Future<void> _openPharmacistWorkspace() async {
    if (!_hasApprovedPharmacistAccess) {
      _showSnack(
        'Only approved pharmacists can open the consultation workspace.',
      );
      return;
    }
  ...
  bool get _hasApprovedPharmacistAccess =>
      widget.isPharmacist ||
      widget.pharmacistStatus.toLowerCase().trim() == 'approved';
  ...
  Widget _buildPharmacyUpgradeCard() {
    final normalizedStatus = _hasApprovedPharmacistAccess
        ? 'approved'
